                    ...
                    <div class="formulaire">   
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-8 col-md-push-2 col-10 col-sm-push-1 col-12">
                                ...
                                <p class="construction">PAGE EN CONSTRUCTION</br>
									</br>
									Envoyer un message : <a href="mailto:contact@38volts.fr" class="mailTo"><i class="fas fa-at"></i></a></br>
									Appeler : 06 29 82 16 46
								</p>  

                            </div>
                        </div>   <!-- fin justify-content-center -->                     
                    </div>  <!-- fin class formulaire -->                       
                </div>  <!-- fin FORMULAIRE / container -->
...
<footer>
    <div class="container-fluid footerCommun">
        ...
        <script src="assets/formulaire.js"></script>
     </body> 
</html>